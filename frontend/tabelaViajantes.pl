                ...
                [
                    thead([], [
                        tr([],[
                            ...
                            th([scope="col"], "Email"),
                            th([scope="col"], "Senha"),
                            th([scope="col"], "NÌvel de acesso")
                        ]) ]),
                    tbody([], \corpo_tabela_via)
                ]),
            div([], [a([class='btn btn-primary', href='/', style='width: 150px'], 'Voltar ao inÌcio')])
        ]).
    ...
    reply_html_page(
            ...
            form([action='/editarF1', method='POST'],
                [ div([class='row justify-content-start mx-3'],
                    ...
                    p([class='mx-3 px-2'], [a([class='btn btn-primary', href='/', style='width: 200px'], 'Voltar ao in√≠cio')])
                                                    ])]
        )
        ).
