...
form6(_Pedido) :-
    reply_html_page(
        ...
        [h1([class='row mx-3 p'],'Formulario 6'), p([],[]),
         ...
         form([action='/receptorF6', method='POST'],
               [
                %%% MOTORISTA
                ...
                div([class='form-floating mb-3'],
                    [input([type=date, type=textarea, class='form-control', style='max-width: 350px', id='floatingInputGrid', placeholder=' 00/00/0000',name=data_saida]),
                ...
                %%% Data RETORNO
                div([class='form-floating mb-3'],
                    [input([type=date, type=textarea, class='form-control', style='max-width: 350px', id='floatingInputGrid', placeholder=' 00/00/0000',name=data_retorno]),
                ...
                div([class='form-floating col-md-2'], [
                    select([class='form-select',name='lChegada', value='Cidade 1', id='floatingSelectGrid'],
                    \locais_html),
                ...
                div([class='row justify-content-start mx-3'],
                    [
                    div([class='col-md-2'],
                       input([class='btn btn-success', style='width: 150px',name=submit, type=submit, value='Gravar'], [])),
                    div([class='col-md-2'], 
