...
home(_Pedido) :-
    reply_html_page(
        ...
        [ h1([class='row mx-3'],'Proposta de desenvolvimento de software para gestao de viagens da DEAD/UFVJM - SIGEV'),
              ...
              h3(a([ class(['nav-link']),href('/form1')],'Formulario 1 ')),
              h3(a([ class(['nav-link']),href('/form2')],'Formulario 2 ')),
              h3(a([ class(['nav-link']),href('/form3')],'Formulario 3 ')),
              h3(a([ class(['nav-link']),href('/form4')],'Formulario 4 ')),
              h3(a([ class(['nav-link']),href('/form5')],'Formulario 5 ')),
              h3(a([ class(['nav-link']),href('/form6')],'Formulario 6 '))
        ]).
