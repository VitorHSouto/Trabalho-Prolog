         ...
         form([action='/receptorF1', method='POST'],
               [ div([class='row justify-content-start mx-3'],
                       ...
                       div([class='col-md-4'],[div([class='form-floating mb-3'],
                           [ input([type=textarea, class='form-control', style='min-width:200px max-width:450px', id='floatingInputGrid',placeholder='Joï¿½o Dos Santos',name=name]),
                 ...
                 p([class='mx-3 px-2'], [a([class='btn btn-primary', href='/', style='width: 200px'], 'Voltar ao inÃ­cio')])
                                                ])]).
